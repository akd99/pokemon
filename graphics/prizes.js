...
p2prizeRep.on('change', (newVal) => {
    ...
    if (newVal == 0) {
        ...
        rightPrize3El.innerHTML = "&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;&nbsp;";
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;";
        rightPrize6El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>";
    } else if (newVal == 1) {
        rightPrize1El.innerHTML = "<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize2El.innerHTML = "&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize3El.innerHTML = "&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;&nbsp;";
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;";
        ...
        rightPrize1El.innerHTML = "<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize2El.innerHTML = "&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize3El.innerHTML = "&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;&nbsp;";
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;";
        rightPrize6El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>";
        ...
        rightPrize1El.innerHTML = "<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize2El.innerHTML = "&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize3El.innerHTML = "&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;";
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;";
        rightPrize6El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>";
    } else if (newVal == 4) {
        ...
        rightPrize2El.innerHTML = "&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize3El.innerHTML = "&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;";
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>&nbsp;";
        rightPrize6El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>";
    } else if (newVal == 5) {
        rightPrize1El.innerHTML = "<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        ...
        rightPrize3El.innerHTML = "&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;";
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;";
        rightPrize6El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballbw.png width=50 height=50>";
    } else if (newVal == 6) {
        rightPrize1El.innerHTML = "<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        rightPrize2El.innerHTML = "&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;&nbsp;&nbsp;";
        ...
        rightPrize4El.innerHTML = "&nbsp;&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;&nbsp;";
        rightPrize5El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>&nbsp;";
        rightPrize6El.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=pokeballred.png width=50 height=50>";
    }
})